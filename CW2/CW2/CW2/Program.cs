...
namespace cw2
{
    class Program
    {
        ...
        {
            string logpath = @"C:\Users\kubaj\Desktop\APBD\CW2";
        ...
        static void Main(string[] args)
        {
            try
            {
                String csvpath = Console.ReadLine(); //Desktop\APBD\cw2\dane.csv
                String xmlpath = Console.ReadLine(); //\Desktop\APBD\cw2
